...
> 作者：[程序员yuxin](https://github.com/liyuxin)
> 仅分享于 [编程导航知识星球](https://yuxin.icu)
...
> 所有需要修改的地方yuxin都标记了 `todo`，便于大家找到修改的位置~
...
找到 job 目录下的 `FullSyncinterfaceToEs` 和 `IncSyncinterfaceToEs` 文件，取消掉 `@Component` 注解的注释，再次执行程序即可触发同步：
